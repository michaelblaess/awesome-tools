...
| Name | Beschreibung |
|------|--------------|
| [Beyond Compare](https://www.scootersoftware.com/) | Bestes Tool zum Vergleichen von Dateien und Ordnern - unterstützt Text, Binär, Bilder, Archive |
| [Bruno](https://www.usebruno.com/) | Open-Source Postman-Alternative - reifer, große Community, Git-freundliches `.bru`-Format, kein Cloud-Zwang |
| [DebugView](https://learn.microsoft.com/en-us/sysinternals/downloads/debugview) | Sysinternals-Tool zum Anzeigen von `OutputDebugString`-Ausgaben - moderner Nachfolger des klassischen [DbMon](https://learn.microsoft.com/en-us/windows/win32/debug/outputdebugstring) |
| [dnSpy](https://github.com/dnSpy/dnSpy) | .NET-Decompiler und Debugger - kompilierte .NET-Assemblies untersuchen, editieren und debuggen (aktiver Fork: [dnSpyEx](https://github.com/dnSpyEx/dnSpy)) |
| [Ghidra](https://github.com/NationalSecurityAgency/ghidra) | Open-Source Reverse-Engineering-Framework der NSA - kostenlose Alternative zu IDA Pro |
